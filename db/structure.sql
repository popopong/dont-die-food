...
--
-- Name: index_pantry_items_on_ingredient_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_pantry_items_on_ingredient_id ON public.pantry_items USING btree (ingredient_id);


--
-- Name: index_pantry_items_on_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_pantry_items_on_user_id ON public.pantry_items USING btree (user_id);
...
--
-- Name: pantry_items fk_rails_99063cea88; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pantry_items
    ADD CONSTRAINT fk_rails_99063cea88 FOREIGN KEY (user_id) REFERENCES public.users(id);


--
-- Name: pantry_items fk_rails_aaf74154ae; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pantry_items
    ADD CONSTRAINT fk_rails_aaf74154ae FOREIGN KEY (ingredient_id) REFERENCES public.ingredients(id);
